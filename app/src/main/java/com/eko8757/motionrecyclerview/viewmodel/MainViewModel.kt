package com.eko8757.motionrecyclerview.viewmodel

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.eko8757.motionrecyclerview.R
import com.eko8757.motionrecyclerview.data.FoodModel

class MainViewModel: ViewModel() {

    val listData: MutableLiveData<List<FoodModel>> = MutableLiveData()
    ...
    fun getFoodList(): List<FoodModel> {
        ...
        listData.postValue(foodDummyData)
        return foodDummyData
    }
}